...
import com.woodley.literalura_challenge.repository.AutorRepository;
...
public class AutorService {
    ...
    public Optional<Autor> obtenerAutorPorNombre(String nombre) {
        return autorRepository.findAutorByNombre(nombre);
    }

    public Autor actualizarAutor(Long id, Autor autorDetalles) {
        Autor autor = autorRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Autor no encontrado para el id: " + id));
